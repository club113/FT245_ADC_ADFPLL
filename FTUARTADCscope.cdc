...
Project.device.outputDirectory=H\:\\ISE\\ISE_PRJ\\008 FT245ADC\\FT245ADC\\Working\\_ngo
...
Project.unit<0>.triggerChannel<0><6>=ReadADCarm/UART1/RD_reg_rstpot
Project.unit<0>.triggerChannel<0><7>=ReadADCarm/UART1/WR_reg_rstpot
Project.unit<0>.triggerChannel<0><8>=ReadADCarm/TxValid
Project.unit<0>.triggerChannel<0><9>=ReadADCarm/TxDone
